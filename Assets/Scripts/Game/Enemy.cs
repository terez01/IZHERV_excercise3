...
public class Enemy : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
         ...
         *    Can return null, which should be checked for!on.
         *  
         *    Use player's transform to determine their positi  Rotation can be calculated using Quaternion.LookRotation(direction, Vector3.forward).
        ...
        {
            // Extract the Transform from the GameObject
            Transform targetPlayer = nearestPlayerObject.transform;
